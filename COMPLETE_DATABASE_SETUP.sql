-- =====================================================
-- MZANSI FOOD CONNECT - COMPLETE DATABASE SETUP
-- =====================================================
-- This script creates the entire database from scratch
-- Run this in your Supabase SQL Editor after deleting everything
-- =====================================================
...
-- You must create the 'store-assets' bucket manually in Supabase Dashboard
-- Then run these policies:

-- Storage RLS policies for store-assets bucket
...
-- 3. Apply storage RLS policies (commented above)
