-- =====================================================
-- COMPLETE FIX FOR MZANSI FOOD CONNECT
...
-- =====================================================
-- PART 2: FIX ANALYTICS VIEWS
-- =====================================================

-- Drop old views that reference payment_method
...
-- Test the views
SELECT 'Daily Analytics' as view_name, COUNT(*) as row_count FROM store_analytics_daily
UNION ALL
